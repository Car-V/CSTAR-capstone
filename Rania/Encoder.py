...
class Encoder:
    ...
    def get_rotation_direction(self):
        ...
        elif (prev_a, prev_b) == (1, 1) and (curr_a, curr_b) == (0, 1):
            self.direction = 1  # Clockwise (11 -> 01)
        elif (prev_a, prev_b) == (0, 1) and (curr_a, curr_b) == (0, 0):
            self.direction = 1  # Clockwise (01 -> 00)
        elif (prev_a, prev_b) == (0, 0) and (curr_a, curr_b) == (0, 1):
            self.direction = -1  # Counterclockwise (00 -> 01)
        elif (prev_a, prev_b) == (0, 1) and (curr_a, curr_b) == (1, 1):
            self.direction = -1  # Counterclockwise (01 -> 11)
        elif (prev_a, prev_b) == (1, 1) and (curr_a, curr_b) == (1, 0):
            self.direction = -1  # Counterclockwise (11 -> 10)
        elif (prev_a, prev_b) == (1, 0) and (curr_a, curr_b) == (0, 0):
